...
public class AzureDevOpsRepoSCMNavigatorTraitsTest {
    @ClassRule
    public static JenkinsRule j = new JenkinsRule();
    @Rule
    public TestName currentTestName = new TestName();

    private AzureDevOpsRepoSCMNavigator load() {
        return load(currentTestName.getMethodName());
    }

    private AzureDevOpsRepoSCMNavigator load(String dataSet) {
        return (AzureDevOpsRepoSCMNavigator) Jenkins.XSTREAM2.fromXML(
