...
public class EndpointTest {
    ...
    public void cantGet_doCheckApiUri() throws IOException, SAXException {
        try {
            j.createWebClient().goTo(appendCrumb("descriptorByName/org.jenkinsci.plugins.azure_devops_repo_branch_source.Endpoint/checkApiUri?apiUri=" + testUrl));
    ...
    public void cantPostAsAnonymous_doCheckApiUri() throws Exception {
        try {
            post("descriptorByName/org.jenkinsci.plugins.azure_devops_repo_branch_source.Endpoint/checkApiUri?apiUri=" + testUrl, null);
            fail("Should not be able to do that");
        } catch (FailingHttpStatusCodeException e) {
    ...
    public void canPostAsAdmin_doCheckApiUri() throws Exception {
        post("descriptorByName/org.jenkinsci.plugins.azure_devops_repo_branch_source.Endpoint/checkApiUri?apiUri=" + testUrl, "alice");
